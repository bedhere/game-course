...
To launch the game, open `game/package.json` and click the ![](images/run.svg) icon next to the `dev` script in the IDE interface.
...
Remember to always stop your application when you're finished. Click the ![](images/stop.svg) button in the tool window at the bottom of your IDE or press `^C` (Ctrl+C).
